...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 HEAD(){ for (( a=1; a<=10; a++ ))
  ...
  TPUT 3 2
        $E "$(tput setaf 2)  Справочник Pyton3 архив$(tput sgr 0)";
  TPUT 7 2
...
# 4 и далее это отступ сверху и 48 это расстояние слева
 M0(){ TPUT  5 3; $e " Разархивировать (скрипт)     ";}
 M1(){ TPUT  6 3; $e " Разархивировать (исполнение) ";}
#
 M2(){ TPUT  8 3; $e " EXIT                         ";}
...
";ES;fi;;
 ...
 ./pyunzip.py filename.zip
";ES;fi;;
        2) S=M2;SC;if [[ $cur == enter ]];then R;clear;ls -l;exit 0;fi;;
 esac;POS;done
